							...
							if Consult then
								if Consult == "Nothing" then
									for Line,v in pairs(Informations) do
										...
										exports["dynamic"]:AddButton("Comprar com Dólares","Custo de <blue>$"..parseFormat(v["Price"]).."</blue> dólares.","propertys:Buy",Name.."-"..Line.."-Dollars",Line,true)
										exports["dynamic"]:AddButton("Comprar com Diamantes","Custo de <blue>"..parseFormat(v["Gemstone"]).."</blue> diamantes.","propertys:Buy",Name.."-"..Line.."-Gemstone",Line,true)
