...
AddEventHandler("police:Escape",function()
	...
	if Passport and Identity then
		if Identity["Prison"] > 0  then
			...
			if vRP.Request(source,"Prisioneiro","Parece que você quer escapar da prisão, mas para isso acontecer você vai ter que deixar comigo o custeio de <b>$"..parseFormat(EscapePrice).."</b> dólares, ta afim?") then
