...
local NPCs = {
	{ -- Bail Office Davis
		...
		Distance = 15,
		Coords = { 1897.43, 3714.94, 32.74, 34.02 },
		Model = "s_m_m_strpreach_01",
		anim = { "anim@heists@heist_corona@single_team", "single_team_loop_boss" }
	},  { -- Hookah and Bar Strip
		Distance = 15,
		Coords = { 1897.56, 3725.0, 33.09, 127.56 },
		Model = "mp_f_stripperlite",
		anim = { "switch@trevor@mocks_lapdance", "001443_01_trvs_28_idle_stripper" }
	}, { -- Departament Store
		Distance = 15,
