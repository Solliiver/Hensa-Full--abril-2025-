            ...
            if not WorkingProperty then
                for k,v in pairs(PropertysCleaner) do
                    ...
                    if Distance <= 30.0 then
						SetDrawOrigin(v["Entrance"][1],v["Entrance"][2],v["Entrance"][3])
						DrawSprite("Targets","G",0.0,0.0,0.02,0.02 * GetAspectRatio(false),0.0,255,255,255,255)
						ClearDrawOrigin()
